...
function voice_commands() {
  ...
  terminaldiv.innerHTML = 'Only supported <e>VOICE</e> commands are listed below:<br><br>' +
    ...
    '<e>"developer"</e> : see code info<br>' +
    '<e>"nuclear hijack"</e> : connect : NSA & steal nuclear code<br>' +
    '<e>"matrix"</e> : show matrix display<br>' +
    '<e>"date"</e> : show current date<br>' +
    ...
    '<e>"decrypt key"</e> : decrypt SHA2 encrypted hash key<br>' +
    ...
    '<e>"pdns utility"</e> : Demo of pdnsutil<br>';
}
...
function dev_info() {
  ...
  terminaldiv.innerHTML = 'Developer Info<br>' +
    ...
    'Updated to v3.0 on: <e>26 October 2018</e><br>' +
...
function matrix() {
  ...
  function draw() {
    ...
    for (i = 0; i < mtrx.length; i++) {
      ...
      if (mtrx[i] * size > cvs.height && Math.random() > 0.975) { mtrx[i] = 0 }
      mtrx[i]++;
    }
  }
...
function date() {
  ...
  document.getElementById("terminal").innerHTML = '<br><br><br><e>' + dd + ' ' + month + ' ' + yy + '</e>';
}
// Show Current Time
function time() {
  // Creating Clock
...
function fuck_you() {
  ...
  terminaldiv.innerHTML = "<e>I don't know who the fuck are you !</e><br>";
}